...
TEST_METRICS = {
    ...
    "ranking__ndcg_at_10": "test_ndcg_at_10",
    "ranking__ndcg_at_25": "test_ndcg_at_25",
    "ranking__ndcg_at_50": "test_ndcg_at_50",
    "ranking__ndcg_at_100": "test_ndcg_at_100",
    "ranking__top10_overlap_rate": "test_top10_overlap_rate",
    "ranking__top25_overlap_rate": "test_top25_overlap_rate",
    "ranking__top50_overlap_rate": "test_top50_overlap_rate",
    "ranking__top100_overlap_rate": "test_top100_overlap_rate",
    "ranking__top_5pct_overlap_rate": "test_top_5pct_overlap_rate",
...
VALIDATION_METRICS = {
    ...
    "ranking__ndcg_at_10": "validation_ndcg_at_10",
    "ranking__ndcg_at_25": "validation_ndcg_at_25",
    "ranking__ndcg_at_50": "validation_ndcg_at_50",
    "ranking__ndcg_at_100": "validation_ndcg_at_100",
    "ranking__top10_overlap_rate": "validation_top10_overlap_rate",
    "ranking__top25_overlap_rate": "validation_top25_overlap_rate",
    "ranking__top50_overlap_rate": "validation_top50_overlap_rate",
    "ranking__top100_overlap_rate": "validation_top100_overlap_rate",
    "ranking__top_5pct_overlap_rate": "validation_top_5pct_overlap_rate",
...
def build_final_comparison(
    *,
    ...
    wanted_cols = [
        ...
        "test_ndcg_at_50",
        "test_ndcg_at_100",
        "test_top10_overlap_rate",
        "test_top25_overlap_rate",
        "test_top50_overlap_rate",
        "test_top100_overlap_rate",
        "test_top_5pct_overlap_rate",
...
def build_factor_summary(audit: pd.DataFrame, *, selection_metric: str) -> pd.DataFrame:
    ...
    numeric_cols = [
        ...
        "validation_ndcg_at_25",
        "validation_ndcg_at_50",
        "validation_ndcg_at_100",
        "validation_spearman",
        "validation_top10_overlap_rate",
        "validation_top25_overlap_rate",
        "validation_top50_overlap_rate",
        "validation_top100_overlap_rate",
        "validation_top_5pct_overlap_rate",
...
def metric_winners(final_comparison: pd.DataFrame) -> pd.DataFrame:
    ...
    specs = [
        ("test_mae", False),
        ("test_spearman", True),
        ("test_ndcg_at_10", True),
        ("test_ndcg_at_25", True),
        ("test_ndcg_at_50", True),
        ("test_ndcg_at_100", True),
        ("test_top10_overlap_rate", True),
...
def render_report(
    *,
    ...
    preview_cols = [
        ...
        "mean_validation_ndcg_at_25",
        "best_validation_ndcg_at_25",
        "mean_validation_ndcg_at_50",
        "best_validation_ndcg_at_50",
        "mean_validation_ndcg_at_100",
        "best_validation_ndcg_at_100",
        "mean_test_ndcg_at_10",
        "best_test_ndcg_at_10",
        "mean_test_ndcg_at_25",
        "best_test_ndcg_at_25",
        "mean_test_ndcg_at_50",
        "best_test_ndcg_at_50",
