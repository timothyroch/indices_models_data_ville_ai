...
Outputs include:
  ...
  figures/
    ...
    09_full_tract_month_graph_hairball.png
    10_full_artifact_graph_hairball_with_placebo.png
...
def generate_visuals(
    ...
    *,
    ...
    full_nodes = add_layered_tract_month_positions(node_table)
    full_modes: list[str]
    ...
    for mode in full_modes:
        ...
        if mode == "real":
            fig_name = "09_full_tract_month_graph_hairball.png"
            title = "Full real tract-month graph"
            export_prefix = "full_tract_month_graph"
        else:
            fig_name = "10_full_artifact_graph_hairball_with_placebo.png"
            title = "Full artifact graph including placebo controls"
            export_prefix = "full_artifact_graph_with_placebo"
        fig_path = paths.figures_dir / fig_name
        plot_full_tract_month_hairball(
            full_nodes,
            full_edges,
            fig_path,
            title=title,
